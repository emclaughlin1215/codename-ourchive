...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { type_description: @type.type_description, type_title: @type.type_title }
    end
  ...
  test "should update type" do
    patch :update, id: @type, type: { type_description: @type.type_description, type_title: @type.type_title }
    assert_redirected_to type_path(assigns(:type))
  end
